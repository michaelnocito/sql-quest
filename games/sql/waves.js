...
window.WAVES = [
  {
    ...
    objective: "Return every row from the <code>enemies</code> table. Hint: <code>SELECT *</code> grabs all columns — <code>*</code> means &ldquo;everything.&rdquo;",
...

  {
    ...
    objective: "Return only the <code>name</code> and <code>type</code> columns. Hint: list both names after <code>SELECT</code>, separated by a comma.",
...

  {
    ...
    objective: "Return each enemy once — no duplicate rows. Hint: add <code>DISTINCT</code> right after <code>SELECT</code>.",
...

  {
    ...
    objective: "Return only the Raiders. Hint: filter with <code>WHERE type = 'Raider'</code> — text goes in quotes.",
...

  {
    ...
    objective: "Return enemies with more than 50 health. Hint: <code>WHERE health &gt; 50</code> — numbers never need quotes.",
...

  {
    ...
    objective: "Return Raiders that also have more than 50 health. Hint: join two conditions with <code>AND</code> — a row must pass both.",
...

  {
    ...
    objective: "Return every Raider and every Warden. Hint: <code>WHERE type = 'Raider' OR type = 'Warden'</code> — either one counts.",
...

  {
    ...
    objective: "Return all enemies, highest health first. Hint: add <code>ORDER BY health DESC</code> after the table name.",
...

  {
    ...
    objective: "Return only the 3 highest-health enemies. Hint: <code>ORDER BY health DESC</code> first, then <code>LIMIT 3</code>.",
...

  {
    ...
    objective: "Return only enemies that have a bounty. Hint: <code>JOIN bounties b ON e.id = b.enemy_id</code> — the column the two tables share.",
...

  {
    ...
    objective: "Return all enemies, bounty or not. Hint: <code>LEFT JOIN</code> keeps every left-table row; no match fills in <code>NULL</code>.",
...

  {
    ...
    objective: "Return only enemies with no weakness on record. Hint: <code>WHERE weakness IS NULL</code> — never <code>= NULL</code>, it won't work.",
...

  {
    ...
    objective: "Return every Raider and Warden. Hint: <code>WHERE type IN ('Raider', 'Warden')</code> checks a whole list at once.",
...

  {
    ...
    objective: "Return enemies with health from 50 to 100. Hint: <code>WHERE health BETWEEN 50 AND 100</code> — both ends included.",
...

  {
    ...
    objective: "Return every enemy whose name starts with V. Hint: <code>WHERE name LIKE 'V%'</code> — <code>%</code> matches any characters that follow.",
...

  {
    ...
    objective: "Return how many Raiders there are — a single number. Hint: <code>SELECT COUNT(*)</code>, and keep your <code>WHERE</code>.",
...

  {
    ...
    objective: "Return the total health of all enemies — a single number. Hint: <code>SELECT SUM(health)</code> adds the column across every row.",
...

  {
    ...
    objective: "Return the single highest health value. Hint: <code>SELECT MAX(health)</code> returns just the largest number in the column.",
...

  {
    ...
    objective: "Return one count per class. Hint: <code>SELECT type, COUNT(*)</code> with <code>GROUP BY type</code> — one row per distinct type.",
...

  {
    ...
    objective: "Return only classes with 3 or more units. Hint: <code>GROUP BY type</code>, then <code>HAVING COUNT(*) &gt;= 3</code>.",
...

  {
    ...
    objective: "Return each class and its unit count, biggest first. Hint: name <code>COUNT(*)</code> with <code>AS n</code>, then <code>ORDER BY n DESC</code>.",
...

  {
    ...
    objective: "Return all Warden contacts. Hint: <code>WHERE type = 'Warden'</code> — text goes in quotes.",
    ...
    phases: [
      ...
      },
      {
        ...
        objective: "Return Wardens with more than 60 health. Hint: add <code>AND health &gt; 60</code> after your type filter.",
        solution: "SELECT * FROM enemies WHERE type = 'Warden' AND health > 60;"
      }
    ],
    explain: {
...

  {
    ...
    objective: "Return all Scouts to clear the escort. Hint: <code>WHERE type = 'Scout'</code> isolates one class.",
    ...
    phases: [
      ...
      },
      {
        ...
        objective: "Return all Raiders and Wardens. Hint: <code>WHERE type = 'Raider' OR type = 'Warden'</code> lets either class through.",
        solution: "SELECT * FROM enemies WHERE type = 'Raider' OR type = 'Warden';"
      }
    ],
    explain: {
