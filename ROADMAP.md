...
- **[P1] Geometric/psychedelic character forms** — art direction is psychedelic celestial; replace the placeholder Spire + plain void-motes with **cool geometric/psychedelic "celestial being" characters** (hero + enemy types). Keep the FF turn-based play. Synthetic SVG/CSS, no charcoal/photo assets (Mike decided charcoal doesn't fit this motif).
