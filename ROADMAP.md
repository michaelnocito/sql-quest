...
## Next (queued, agreed)
- **[P2] Distinct enemy archetypes** — the void-being shape is one design for all enemies; later give enemy *types* their own geometric silhouettes (different star/polygon forms, colors) so waves read as varied. Pairs with the advanced-enemy-mechanic item.
