...
## Next (queued, agreed)
- **[P1] Celestial theme — deeper narrative pass** — battlefield reskin shipped; next carry the Celestial Cartographer theme into wave briefings (swarm/turret → motes/Spire/constellations), the splash tagline, concept framing, and naming. Keep instructional text crisp (don't let flavor bury the SQL lesson).
